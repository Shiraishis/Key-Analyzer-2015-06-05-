...
namespace 키값정렬기
{
    class Program
    {
        public string key, key1, key2, key3, key4, key5, key6, key7, key8;
        public string key1_1, key1_2, key1_3;
        public string key2_1, key2_2, key2_3;
        public string key3_1, key3_2, key3_3;
        public string key4_1, key4_2, key4_3;
        public string key5_1, key5_2, key5_3;
        public string key6_1, key6_2, key6_3;
        public string key7_1, key7_2, key7_3;
        public string key8_1, key8_2, key8_3;
        ...
        static void Main(string[] args)
        {
            ...
            key1_1 = key.Substring(2, a);
            key1_2 = key.Substring(4, a);
            key1_3 = key.Substring(6, a);
            key2 = key.Substring(8, a);
            key2_1 = key.Substring(10, a);
            key2_2 = key.Substring(12, a);
            key2_3 = key.Substring(14, a);
            key3 = key.Substring(16, a);
            key3_1 = key.Substring(18, a);
            key3_2 = key.Substring(20, a);
            key3_3 = key.Substring(22, a);
            key4 = key.Substring(24, a);
            key4_1 = key.Substring(26, a);
            key4_2 = key.Substring(28, a);
            key4_3 = key.Substring(30, a);
            key5 = key.Substring(32, a);
            key5_1 = key.Substring(34, a);
            key5_2 = key.Substring(36, a);
            key5_3 = key.Substring(38, a);
            key6 = key.Substring(40, a);
            key6_1 = key.Substring(42, a);
            key6_2 = key.Substring(44, a);
            key6_3 = key.Substring(46, a);
            key7 = key.Substring(48, a);
            key7_1 = key.Substring(50, a);
            key7_2 = key.Substring(52, a);
            key7_3 = key.Substring(54, a);
            key8 = key.Substring(56, a);
            key8_1 = key.Substring(58, a);
            key8_2 = key.Substring(60, a);
            key8_3 = key.Substring(62, a);
            Console.Beep();
